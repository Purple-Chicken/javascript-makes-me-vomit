...
const html = `
  <div class="box-container" style="max-width: 600px;">
    ...
    <p style="font-size: 0.9em; color: var(--text-muted); margin-bottom: 32px; letter-spacing: 0.08em; text-transform: uppercase; font-family: 'Neo Tech', monospace;">Local AI Chat</p>
